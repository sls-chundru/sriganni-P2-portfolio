...
The regression results indicate that height is modeled with income and eye color as predictors show that
1.Intercept(195, p-value=0.0104): The intercept represents the estimated height when all the predictors are zero.The sisgnificant p-value indicates that this base height is statistically significant.
